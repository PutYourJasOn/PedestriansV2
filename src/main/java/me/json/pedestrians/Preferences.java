...
public class Preferences {
    ...
    public final static float   PEDESTRIAN_MIN_VELOCITY         = 1f/20f;
    public final static float   PEDESTRIAN_MAX_VELOCITY         = 3f/20f;
    public final static float   PEDESTRIAN_MAX_RUN_VELOCITY     = 4.5f/20f;
